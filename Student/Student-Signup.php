...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    else
    {
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "i", $param_phonenum);
    ...
    if(empty($username_err) && empty($email_err) && empty($phonenum_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (username,email,phonenum, password) VALUES (?,?,?, ?)";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // Attempt to execute the prepared statement
            if(mysqli_stmt_execute($stmt)){
                // Redirect to After Signup Login page
    ...
    <nav class="navbar-sticky navbar navbar-inverse navbar-static-top navigation">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="Student-Login.php">Student-Login <i class="fa fa-sign-in" style="color: blue" aria-hidden="true"></i> </a> </li>
            </ul>
        </div>
      </div>
    </nav>
