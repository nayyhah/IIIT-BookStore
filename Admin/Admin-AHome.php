...
<body translate="no" class="add-books">
    ...
    <nav class="navbar-sticky navbar navbar-inverse navbar-static-top navigation"  style="margin-bottom:95px;">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="Admin-AHome.php"><i class="fa fa-home fa-fw" style="font-size: 20px;" aria-hidden="true"></i>Home</a></li>
    ...
    <!-- Book Shelf -->
    <nav class="shelf">
        <a href="Admin-AHome.php" class="book home-page">Home page</a>
        <a href="Book-Details.php" class="book about-us">Books</a>
        <a href="User-Details.php" class="book contact">User-Details</a></li></a>
        <a href="Orders.php" class="book faq">Order-Details</a>

        <a href="AddBooks.php" class="book not-found"></a>
 
        <span class="door left"></span>
        <span class="door right"></span>
    </nav>
    <h3 style="text-align:center;margin-top:4.3rem;color: rgba(255, 255, 255, 0.719);font-family: 'Roboto', sans-serif;">Admin <i class="fa fa-user" aria-hidden="true"></i></h3>
