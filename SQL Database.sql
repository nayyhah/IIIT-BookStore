...
INSERT INTO `books`(`bookid`, `name`, `author`, `edition`, `status`, `price`, `quantity`) VALUES (NULL, 'Oracle PL/SQL Programming', 'Steven Feuerstein & Bill Pribyl', '6th', 'Available','Images/book1.jpg', 560, 5);
...
INSERT INTO `books`(`bookid`, `name`, `author`, `edition`, `status`, `image`, `price`, `quantity`) (NULL, 'An Introduction to Database Systems', 'Bipin C. Desai', '7th', 'Available','Images/book5.jpg','1050', '7');
INSERT INTO `books`(`bookid`, `name`, `author`, `edition`, `status`, `image`, `price`, `quantity`) (NULL, 'Computer Architecture and Organization', 'William Stallings', '10th', 'Available','Images/book6.jpg', '620','6');
